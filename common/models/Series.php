 ...
 *
 * @property \common\models\Account $owner      User account that owns this record, relationship
 * @property \common\models\Book[]  $books      List of books that belong to this series, relationship
 *
